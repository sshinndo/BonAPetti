...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    if (Logger().petData.isEmpty) Logger().getMyPetList();
    loadData();
  }
                ...
                children: <Widget>[
                          ...
                          return GoodsCardWidget(
                            goodsInfo: GoodsInfo(
                                ...
                                GoodsDetailedInfo(
                                  ...
                                  product[i]["allergicIngredients"],
                                  product[i]["ingredientImageUrl"],
                                  GoodsVendor(
                                      product[i]["siteName1"],
                                      product[i]["price1"],
                                      product[i]["shippingFee1"],
                                      product[i]["goodsUrl1"]),
                                  GoodsVendor(
                                      product[i]["siteName2"],
                                      product[i]["price2"],
                                      product[i]["shippingFee2"],
                                      product[i]["goodsUrl2"]),
                                  GoodsVendor(
                                      product[i]["siteName3"],
                                      product[i]["price3"],
                                      product[i]["shippingFee3"],
                                      product[i]["goodsUrl3"]),
                                )),
                          );
                        }),
                  ...
                  GestureDetector(
                      onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => GoodsScreen()), //사료 정보들
                          ),
                      child: Container(
                          alignment: Alignment.centerRight,
                          child: Text(
                        ...
                        BargainCardWidget(
                          goodsInfo: GoodsInfo(
                              ...
                              GoodsDetailedInfo(
                                ...
                                product[5]["allergicIngredients"],
                                product[5]["ingredientImageUrl"],
                                GoodsVendor(
                                    product[5]["siteName1"],
                                    product[5]["price1"],
                                    product[5]["shippingFee1"],
                                    product[5]["goodsUrl1"]),
                                GoodsVendor(
                                    product[5]["siteName2"],
                                    product[5]["price2"],
                                    product[5]["shippingFee2"],
                                    product[5]["goodsUrl2"]),
                                GoodsVendor(
                                    product[5]["siteName3"],
                                    product[5]["price3"],
                                    product[5]["shippingFee3"],
                                    product[5]["goodsUrl3"]),
                              )),
                        ),
                        BargainCardWidget(
                          goodsInfo: GoodsInfo(
                              ...
                              GoodsDetailedInfo(
                                ...
                                product[6]["allergicIngredients"],
                                product[6]["ingredientImageUrl"],
                                GoodsVendor(
                                    product[6]["siteName1"],
                                    product[6]["price1"],
                                    product[6]["shippingFee1"],
                                    product[6]["goodsUrl1"]),
                                GoodsVendor(
                                    product[6]["siteName2"],
                                    product[6]["price2"],
                                    product[6]["shippingFee2"],
                                    product[6]["goodsUrl2"]),
                                GoodsVendor(
                                    product[6]["siteName3"],
                                    product[6]["price3"],
                                    product[6]["shippingFee3"],
                                    product[6]["goodsUrl3"]),
                              )),
                        ), //훈제 나눔 카드
                        BargainCardWidget(
                          goodsInfo: GoodsInfo(
                              ...
                              GoodsDetailedInfo(
                                ...
                                product[7]["allergicIngredients"],
                                product[7]["ingredientImageUrl"],
                                GoodsVendor(
                                    product[7]["siteName1"],
                                    product[7]["price1"],
                                    product[7]["shippingFee1"],
                                    product[7]["goodsUrl1"]),
                                GoodsVendor(
                                    product[7]["siteName2"],
                                    product[7]["price2"],
                                    product[7]["shippingFee2"],
                                    product[7]["goodsUrl2"]),
                                GoodsVendor(
                                    product[7]["siteName3"],
                                    product[7]["price3"],
                                    product[7]["shippingFee3"],
                                    product[7]["goodsUrl3"]),
                              )),
                        ), //유기농 개사료 나눔 카드
                      ],
